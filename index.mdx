...
<CardGroup cols={2}>
  <Card title="Fine-Tuning" icon="sliders" href="/knowledgebase">
...
<CardGroup cols={2}>
  <Card title="Inference" icon="rocket" href="/batch inference/model operations">
    Call deployed models via API for real-time predictions.
  </Card>

  <Card title="Deployment" icon="microchip" href="/deployments">
