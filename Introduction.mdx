...
<CardGroup cols={2}>
  <Card title="Trainings" icon="sliders" href="introduction">
...
<CardGroup cols={2}>
  <Card title="Inference" icon="rocket" href="batch-inference">
...
<Steps>
  ...
  <Step title="Training Models">
    Follow the [Training guide](introduction) to customize models for your use case
  </Step>
</Steps>